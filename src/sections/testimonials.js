    ...
    [
        {
            ...
            name: "Veona Watson",
            username: "@hi.veona",
            text: `I would just like to compliment Shehjad from Sassdads. He has been most professional and gone to great lengths to assist me. HIS patience with me as I continuously changed my plans is to be commended. Thank you`,
        },
        {
            id: 2,
            avatar: avatar2,
            ...
            text: `The way they helped me to validate my idea was very helpful from day 1. I was unsure of the edge cases that my idea could miss but there was Sassdads to take their time and find the optimum version of my niche.`,
        },
    ],
    [
        {
            ...
            text: `Many thanks for you kind and efficient service. I have already and will definitely continue to recommend your services to others in the future. The way they build my MVP and have maintained it along the journey is phenomenal`,
        },
        {
            id: 4,
            avatar: avatar4,
            name: "Paseka Nku",
            username: "@hey.nku",
            text: `Theres no going back from getting services from Sassdads. Everything from validation to growth ahcking along with marketing. All services at one place. HATS OFF`,
        },
    ],
    /* 
  [
