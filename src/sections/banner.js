            ...
            <Container>
                <Box sx={styles.contentWrapper}>
                    <Box sx={styles.bannerContent}>
                        <Heading as="h1">
                            Take your SASS to a whole new level
                        </Heading>
                        <Text as="p">
                            Leave the duty in our hands and we will do whats
                            required to make your sass profitable while also
                            maintaining phenomenal quality.
                        </Text>
